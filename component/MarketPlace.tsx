...
export default function MarketPlace() {
  ...
  return (
    <>
      <div className="bg-orange-50 py-16 mt-8" id='renters-owners'>
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Renters Card */}
            <div className="bg-orange-200 rounded-[20px] p-8 cursor-pointer transition-all duration-200 hover:scale-[1.02] hover:shadow-lg">
            ...
            <div className="bg-blue-50 rounded-[20px] p-8 cursor-pointer transition-all duration-200 hover:scale-[1.02] hover:shadow-lg">
